...
if __name__ == "__main__":
    ...
    full_data = array.as_outer_basis(array.as_outer_basis(array.as_inner_basis(kernel)))
    ...
    diagonal_data = array.flatten(array.as_outer_basis(array.as_inner_basis(kernel)))
    ...
    cl_data = array.as_outer_basis(
        array.as_outer_basis(array.as_inner_basis(kernel_cl))
    )
    ...
    ax.legend()
    ax.set_title("Comparison of CL approximation to Gaussian Kernel")
    fig.show()
