...
class Operator[
    ...
    DT: np.generic,
    B: Basis[StackedMetadata[BasisMetadata, Any], Any] = Basis[M, DT],
](SlateArray[M, DT, B]):
    """Represents an operator in a quantum system."""

    def __init__[DT1: np.generic, B1: Basis[StackedMetadata[BasisMetadata, Any], Any]](
    ...
    @overload
    def __add__[M1: StackedMetadata[BasisMetadata, Any], DT1: np.number[Any]](
    ...
    @overload
    def __sub__[M1: StackedMetadata[BasisMetadata, Any], DT1: np.number[Any]](
        self: Operator[M1, DT1],
        other: Operator[M1, DT1],
    ) -> Operator[M1, DT1]: ...
    ...
    @override
    def __mul__[M1: StackedMetadata[BasisMetadata, Any], DT1: np.number[Any]](
        self: SlateArray[M1, DT1],
        other: float,
    ) -> Operator[M1, DT1]:
...
class OperatorList[
    ...
    def with_operator_basis[B1: Basis[Any, Any]](  # B1: B
        self, basis: B1
    ) -> OperatorList[M, DT, VariadicTupleBasis[Any, Basis[M, Any], B1, None]]:
        """Get the Operator with the operator basis set to basis."""
        final_basis = tuple_basis(
            (cast(Basis[M, Any], as_tuple_basis(self.basis)[0]), basis),
    ...
    def with_list_basis[B1: Basis[Any, Any]](  # B1: B
        self, basis: B1
    ) -> OperatorList[M, DT, VariadicTupleBasis[np.generic, B1, Basis[M, Any], None]]:
        """Get the Operator with the operator basis set to basis."""
        final_basis = tuple_basis(
    ...
    def from_operators[
        ...
        DT1,
        VariadicTupleBasis[Any, FundamentalBasis[SimpleMetadata], B1, None],
    ]:
